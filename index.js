...
//Ans. 
let nameOfPerson = "Ayesha Arshad";
...
let strippedName = nameWithWhiteSapce.trim();
...
//Ans:
let favourite_Number = 786;
let messageToShow = `${favourite_Number} is my  favourite number.`;
...
//Ans:
let friendsNames = ["Sonia", "Beenish", "Gulnaz", "Zainab"];
...
//Ans:
let friendsList = ["Sonia", "Beenish", "Gulnaz", "Zainab"];
for (let i = 0; i < friendsNames.length; i++) {
...
//Ans:
let motorcycles = ["Honda", "Harley-Davidson", "Kawasaki", "Ducati", "Yamaha"];
...
//Ans:
let invitedPersons = ['Mehwish', 'Rimsha', 'Shahzadi', 'Afia'];
let message1 = "You're invited to dinner tonight at my place. We'd love to have you for great food and conversation. ";
...
//changed.
//Ans:
let locations = ['Hunza Valley', 'Attabad Lake', 'Naran Kaghan', 'Badshahi Mosque', 'Swat Valley'];
...
//Ans:
let pak_places = ['Data Darbar', 'Badshahi Mosque', 'Shrine of Lal Shahbaz Qalandar', 'Faisal Mosque', 'Blue Mosque Replica'];
...
let userNames = ["Humna", "Zoni", "Faiza"];
...
//Ans:
let current_users = ["Sonia", "Sana", "Zainab", "Sania", "Zahra"];
let new_users = ["Zoya", "Jaweria", "Muskan", "Noor", "Anumtah"];
...
//Ans:
let pizza = ['Pepproni', 'Chicken Fajita', 'Chicken Milai Boti', 'Margherita',];
